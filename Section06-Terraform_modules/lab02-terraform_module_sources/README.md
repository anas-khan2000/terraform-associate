1. first tested terraform module using source = local by moving existing server directory under modules and creating a new directory under modules as web_server.
