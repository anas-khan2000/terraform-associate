...
To authenticate and securely store Terraform state in an S3 bucket using the standard backend configuration, following are below steps-
...
1. **Sign Up for Terraform Cloud**  
    ...
    Create an org if already dont have one.
